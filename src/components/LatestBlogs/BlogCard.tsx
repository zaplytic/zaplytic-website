...
export default function BlogCard({ title, category, img, href }: BlogCardProps) {
  return (
    <a className="group flex flex-col bg-white border border-gray-200 shadow-2xs rounded-xl hover:shadow-md focus:outline-hidden focus:shadow-md transition dark:bg-neutral-900 dark:border-neutral-800" href={href}>
