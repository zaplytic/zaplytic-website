      ...
      <div className="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 pt-12 md:pt-24 pb-10">
        ...
        <div className="mt-8 max-w-3xl text-center mx-auto">
          <p className="text-lg text-gray-600 dark:text-neutral-400" id="hero-subtitle">
            We build high-quality, easy-to-use open-source tools and SaaS products to solve real-world problems and empower developers, businesses, and everyday users.
          </p>
        </div>
        <div className="mt-16 gap-3 flex justify-center" id="hero-action">
          <Link className="inline-flex justify-center items-center gap-x-3 text-center transition-colors duration-1000 bg-gradient-to-l from-cyan-500 to-lime-500 hover:from-lime-500 hover:to-cyan-500 focus:from-lime-500 focus:to-cyan-500 focus:outline-none border border-transparent text-gray-900 text-sm font-medium rounded-full py-3 px-4" to="/products">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-6" aria-hidden="true" focusable="false">
